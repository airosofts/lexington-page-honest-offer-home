...
const FAQ_ITEMS: FaqItem[] = [
  {
    q: "How do you calculate your offer for my Louisville, KY home?",
    a: "We look at what comparable renovated homes in your Louisville neighborhood are selling for (the after-repair value), subtract a realistic estimate of work your house needs, subtract our holding and selling costs, and keep a modest margin. We'll walk you through the math on the phone. No black box, no guessing.",
  },
  {
    q: "Is there really no obligation after I submit?",
    a: "Correct. You submit the form, we send you a written offer, and you decide. If the number doesn't work, tell us and we're done. We don't hassle, we don't put you on a drip campaign, and we don't sell your info. Many Louisville homeowners get our offer and use it as a floor when deciding whether to list — that's completely fine.",
  },
  {
    q: "What if my Louisville house needs a lot of work?",
    a: "That's our specialty. Foundation cracks, leaking roofs, old kitchens, fire damage, hoarder situations — we've bought all of it across Jefferson County and the Louisville metro. Don't clean, don't repair, don't apologize. Our contractors handle it on the back end.",
  },
  {
    q: "Who pays closing costs when selling in Louisville?",
    a: "We do. Title fees, recording fees, prorated Jefferson County property taxes — all of it. The offer amount we send you is what wires to your account at closing. No deductions, no surprise line items at the title company.",
  },
  {
    q: "How fast can you close on a house in Louisville?",
    a: "Our fastest close on record is 5 business days. Most Louisville deals close in 10–21 days depending on title work. If you need more time — 60 or 90 days to coordinate a move — we can schedule that too. Your timeline runs the show.",
  },
  {
    q: "How is Honest Offer different from national iBuyers?",
    a: "iBuyers like Opendoor charge 5–8% in service fees and renegotiate after inspection. We don't charge a service fee, we don't renegotiate, and we buy homes they won't touch — older properties, rough condition, difficult situations. We're locally owned in Kentucky and the person who calls you back is the same one who shows up in Louisville.",
  },
];
...
const localBusinessSchema = {
  ...
  description:
    "Locally owned cash home buyer serving Louisville and Jefferson County, KY. Fair cash offers in 24 hours. No repairs, no agents, no fees. A+ BBB rated.",
  ...
  return (
    <>
      ...
      <header className="topbar">
        <div className="container-site topbar-inner">
          <Link
            href="/louisville-ky"
            className="brand"
            aria-label="Honest Offer — We Buy Houses in Louisville, KY"
          >
            ...
            <span className="brand-text">
              ...
              <span className="brand-tagline">
                Sell Your House Fast · Louisville, KY
              </span>
            </span>
          </Link>
        ...
        <div className="container-site hero-grid">
          <div className="hero-copy">
            <div className="eyebrow">
              Locally owned · Serving Louisville, KY and Jefferson County
            </div>
            <h1>
              Sell Your House Fast in <em>Louisville, KY</em> — Fair Cash Offer
              in 24 Hours
            </h1>
            <p className="hero-sub">
              We buy houses across Louisville and Jefferson County in any
      ...
      <section className="situations">
        <div className="container-site">
          <div className="section-head">
            <div className="eyebrow">Situations Louisville Homeowners Face</div>
            <h2>We specialize in the complicated ones.</h2>
            <p className="muted" style={{ maxWidth: "58ch" }}>
              Most Louisville homeowners who call us aren&rsquo;t in a
          ...
          <div className="sit-grid">
            <div className="sit">
              ...
              <div>
                ...
                <p>You inherited a Louisville house you don&rsquo;t live in and don&rsquo;t want to manage. We handle probate coordination and buy it as-is, no matter the condition.</p>
              </div>
            </div>
            <div className="sit">
              <div className="sit-icon">
              ...
              <div>
                ...
                <p>You need a clean, fast split. We close quickly and quietly in Louisville — neither party needs to manage showings or negotiate repair lists.</p>
              </div>
            </div>
            <div className="sit">
              <div className="sit-icon">
              ...
              <div>
                ...
                <p>Kentucky foreclosure timelines are tight. We can close fast enough to stop the process, protect your equity, and protect your credit.</p>
              </div>
            </div>
            <div className="sit">
              <div className="sit-icon">
              ...
              <div>
                ...
                <p>Problem tenants, late rent, constant repair calls across Jefferson County. Sell the rental as-is — tenant in place or out — and be done with it.</p>
              </div>
            </div>
            <div className="sit">
              <div className="sit-icon">
              ...
              <div>
                <h4>Relocating from Louisville</h4>
                <p>New job starts in 30 days. You need certainty, not a &ldquo;maybe it sells by then&rdquo; conversation with a Louisville listing agent.</p>
              </div>
            </div>
            <div className="sit">
              <div className="sit-icon">
              ...
              <div>
                ...
                <p>Roof, foundation, plumbing, mold, fire damage. If the repair estimate is bigger than the equity, stop estimating and call us instead.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="benefits">
        <div className="container-site">
          <div className="section-head">
            <div className="eyebrow">Why Louisville Sellers Choose Us</div>
          ...
          <div className="benefit-grid">
            ...
            <div className="benefit">
              ...
              <h4>No repairs</h4>
              <p>No painting, no new carpet, no &ldquo;just fix the HVAC first.&rdquo; We buy Louisville homes exactly as they sit.</p>
            </div>
            <div className="benefit">
              <div className="benefit-icon">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
              ...
              <p>Louisville agents take 5–6% on average. On a $300k home that&rsquo;s $18,000 out of your check. We take $0.</p>
            </div>
            <div className="benefit">
              <div className="benefit-icon">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <section>
        <div className="container-site">
          <div className="section-head centered">
            ...
            <h2>Honest Offer vs. listing with a Louisville agent.</h2>
      ...
      <section className="about">
        <div className="container-site about-grid">
          <div className="about-copy">
            <div className="eyebrow">Your Local Louisville Cash Home Buyer</div>
            <h2>A local Kentucky buyer, not a national call center.</h2>
            <p>
              Honest Offer is a locally owned real estate company serving Louisville and the surrounding Jefferson County area. We buy houses in every Louisville neighborhood — Shively, St. Matthews, Middletown, Okolona, Fern Creek, Jeffersontown, Buechel — and in every condition.
            </p>
            <p>
            ...
            <div className="about-signature">
              ...
              <div>
                ...
                <div className="sig-title">Louisville, KY · Licensed &amp; Insured</div>
              </div>
            </div>
          </div>
      ...
      <section style={{ background: "var(--cream-deep)" }}>
        <div className="container-site">
          <div className="section-head centered">
            ...
            <h2>We buy houses across Louisville, KY and the surrounding area.</h2>
            <p style={{ maxWidth: "54ch", margin: "0 auto" }}>
              Jefferson County is our Louisville home base, but we buy houses throughout the metro and in every surrounding community. If you&rsquo;re in Greater Louisville, we can make you an offer.
            </p>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "0.75rem", marginTop: "2.5rem" }}>
            {[
              { city: "Louisville", note: "Jefferson County — primary market" },
              { city: "Shively", note: "Jefferson County" },
              { city: "St. Matthews", note: "Jefferson County" },
              { city: "Middletown", note: "Jefferson County" },
              { city: "Jeffersontown", note: "Jefferson County" },
              { city: "Okolona", note: "Jefferson County" },
              { city: "La Grange", note: "Oldham County" },
              { city: "Shelbyville", note: "Shelby County" },
            ].map(({ city, note }) => (
      ...
      <section>
        <div className="container-site">
          <div className="section-head centered">
            <div className="eyebrow" style={{ justifyContent: "center" }}>From Real Louisville Sellers</div>
          ...
          <div className="testis">
            <div className="testi">
              ...
              <p className="testi-text">I inherited a house in Shively after my uncle passed. I live in Ohio and had no idea what to do with it. Honest Offer walked me through everything, handled the probate coordination, and gave me a fair number. Closed in three weeks.</p>
              <div className="testi-foot">
                <div className="avatar">DW</div>
                <div>
                  <div className="testi-name">Diane W.</div>
                  <div className="testi-meta">Verified seller · Shively, KY · Inherited property</div>
                </div>
              </div>
            </div>
            <div className="testi">
              <span className="quote-mark" aria-hidden="true">&ldquo;</span>
              <div className="stars">★★★★★</div>
              <p className="testi-text">I had a rental in Okolona that needed a full gut renovation. Couldn&rsquo;t afford the repairs and couldn&rsquo;t find a buyer willing to take it on. Honest Offer bought it in two weeks. The offer was fair for the condition it was in.</p>
              <div className="testi-foot">
                <div className="avatar a2">TM</div>
                <div>
                  <div className="testi-name">Terry M.</div>
                  <div className="testi-meta">Verified seller · Okolona, KY · Rental property</div>
                </div>
              </div>
            </div>
            <div className="testi">
              <span className="quote-mark" aria-hidden="true">&ldquo;</span>
              <div className="stars">★★★★★</div>
              <p className="testi-text">Going through a divorce, we needed to sell the St. Matthews house fast and split it clean. Honest Offer moved quickly, no judgment, no hassle. Exactly what we needed in a tough time.</p>
              <div className="testi-foot">
                <div className="avatar a3">SB</div>
                <div>
                  <div className="testi-name">Sandra B.</div>
                  <div className="testi-meta">Verified seller · St. Matthews, KY · Divorce sale</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section>
        <div className="container-site">
          <div className="section-head centered">
            ...
            <h2>Straight answers for Louisville homeowners.</h2>
          </div>
      ...
      <section className="final-cta">
        <div className="container-site final-cta-inner">
          ...
          <h2>Get your <em>honest</em> offer in Louisville, KY today.</h2>
        ...
        <div className="container-site">
          <div className="foot-grid">
            <div className="foot foot-brand">
              <Link href="/louisville-ky" className="brand" aria-label="Honest Offer — We Buy Houses in Louisville, KY">
                <span className="brand-mark" aria-hidden="true">
                  <svg viewBox="0 0 24 24" fill="none" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                    <path className="mark-house" d="M3 11L12 4l9 7v9H3V11z" />
                    <path className="mark-check" d="M8 14.5l2.5 2.5L16 11.5" />
              ...
              <p>Straight-talk cash offers on houses in Louisville, KY and Jefferson County. Locally owned, family-operated, licensed and insured.</p>
              <a
                href={PHONE_TEL}
            ...
            <div className="foot">
              ...
              <ul>
                ...
                <li>Shively &amp; St. Matthews</li>
                <li>Middletown &amp; Jeffersontown</li>
                <li>La Grange &amp; Shelbyville</li>
              </ul>
            </div>
            <div className="foot">
              <h5>Company</h5>
          ...
          <div className="foot-legal">
            <div>© {new Date().getFullYear()} Honest Offer Inc. · Louisville, KY · Licensed &amp; insured.</div>
            <div>
